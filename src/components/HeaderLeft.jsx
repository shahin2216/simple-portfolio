...
import { BiBriefcase, BiCode, BiHome, BiMailSend, BiRightArrow, BiRightArrowAlt } from "react-icons/bi";
    ...
    <div className="md:flex-[1]">
      <div className="min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-teal-600 text-white">
        <ul className="flex flex-col gap-10">
          {["home", "experience", "project","Skills&Education"].map((item) => (
            <li
              key={item}
      ...
      <div className="fixed left-0 right-0 top-0 z-10 flex justify-evenly bg-teal-600 p-5 text-white md:hidden">
        ...
        <a href="#Skills&Education" className="flex flex-col items-center justify-center">
            <BiCode className="text-2xl" />
        <span className="text-xs">Skills&Education</span>
        </a>
