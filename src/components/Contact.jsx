...
const Contact = () => {
  return (
    <div id="contact" className='flex min-h-screen w-full flex-col items-center justify-center gap-16 p-8'>
      <h3 className='text-center text-6xl font-light text-teal-600'>Get In touch</h3>
      <form className='flex w-full max-w-md flex-col gap-8 rounded-lg p-6 md:max-w-lg lg:max-w-xl'>
        ...
        <textarea name="" id="" placeholder='Your Message' className='h-32 w-full resize-none rounded-lg border-2 border-teal-400 px-4 py-3 text-lg outline-none transition-all duration-200 hover:bg-teal-50 focus:ring-2 focus:ring-teal-500'></textarea>
